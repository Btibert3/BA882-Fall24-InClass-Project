...
def schema_setup():
    ...
    url = "https://us-central1-btibert-ba882-fall24.cloudfunctions.net/mlops-schema-setup"
...
def train():
    ...
    url = "https://us-central1-btibert-ba882-fall24.cloudfunctions.net/mlops-postlength-trainer"
    resp = invoke_gcf(url, payload={})
    return resp
